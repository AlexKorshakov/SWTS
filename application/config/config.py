...
DATA_BASE_MSG_DIR: str = env("DATA_BASE_MSG_DIR")
DATA_BASE_STNG_DIR: str = env("DATA_BASE_STNG_DIR")
DATA_BASE_BAGRATION_EMPLOYEE_ID: str = env("DATA_BASE_BAGRATION_EMPLOYEE_ID")
