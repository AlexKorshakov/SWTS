...
from apps.core.utils.generate_report.generate_daily_report.settings_mip_report import CATEGORY_LIST_VALUES
...
async def set_report_headlines_data_values(chat_id):
...
async def set_mip_photographic_materials_values(worksheet: Worksheet):
    """
