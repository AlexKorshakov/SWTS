...
#                                  lambda call: call.data in list(board_config.menu_list),
...
#
#     for item in registration_file_list:
#         registration_data = registration_data + await read_json_file(item)
#
...
#         chat_id=chat_id, text=registration_text, reply_markup=reply_markup
#     )
#     await bot_send_message(
#         chat_id=chat_id, text=Messages.Successfully.registration_data_received, reply_markup=ReplyKeyboardRemove()
#     )
#
#
