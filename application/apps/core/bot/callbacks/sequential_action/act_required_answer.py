from apps.core.bot.filters.custom_filters import filter_act_required
...
@MyBot.dp.callback_query_handler(filter_act_required, state=ViolationData.all_states)
