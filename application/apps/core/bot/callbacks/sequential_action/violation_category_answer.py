...
from apps.core.bot.filters.custom_filters import filter_violation_category
...
@MyBot.dp.callback_query_handler(filter_violation_category, state=ViolationData.all_states)
