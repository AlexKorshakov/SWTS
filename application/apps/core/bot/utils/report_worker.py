...
from apps.core.bot.utils.generate_report.generator_report import create_act_prescription, \
    create_report_from_other_method, create_mip_report, get_act_number_on_data_base, set_act_data_on_data_base
...
from apps.core.bot.utils.report_worker_utils import get_clear_list_value, get_general_constractor_list, \
